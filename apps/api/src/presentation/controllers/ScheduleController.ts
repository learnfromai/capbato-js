...
export class ScheduleController {
  ...
  /**
   * GET /api/schedules/doctor/:doctorName - Get schedules by doctor name
   */
  @Get('/doctor/:doctorName')
  async getSchedulesByDoctor(@Param('doctorName') doctorName: string): Promise<ScheduleListResponse> {
    const validatedData = this.validationService.validateGetByDoctorQuery({ doctorName });
